...
import com.example.unilife.ViewModel.DownloadProgressUpdaterViewModel
...
class PdfViewerActivity : AppCompatActivity(), DownloadProgressUpdaterViewModel.DownloadProgessListener {

    private lateinit var binding : ActivityPdfViewerBinding
    private lateinit var downloadManager: DownloadManager
    private var downloadProgressUpdaterViewModel : DownloadProgressUpdaterViewModel? = null
    ...
    private fun downloadPdf(downloadUrl: String?, fileName: String?){
        try {
            ...
            downloadProgressUpdaterViewModel = DownloadProgressUpdaterViewModel(downloadManager, downloadId, this)
            binding.progressBar.visibility = View.VISIBLE

            lifecycleScope.launch(Dispatchers.IO){
                downloadProgressUpdaterViewModel?.run()
            }
            snackbar.show()
        }catch (e : Exception){
