...
public final class ActivityArchivioBinding implements ViewBinding {
  ...
  private ActivityArchivioBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton downloadButton, @NonNull ImageButton imageButton,
      @NonNull ConstraintLayout main, @NonNull RecyclerView recyclerView,
      @NonNull TextView textUnilife, @NonNull TextView textView17,
  ...
  public static ActivityArchivioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityArchivioBinding((ConstraintLayout) rootView, downloadButton, imageButton,
          main, recyclerView, textUnilife, textView17, uploadButton);
    }
